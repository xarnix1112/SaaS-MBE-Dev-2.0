...
import { ShippingZone, ZONE_COLORS } from '@/types/shipping';
...
export function ZoneCard({ zone, onUpdate, onDelete }: ZoneCardProps) {
  ...
  const zoneColorClass = ZONE_COLORS[zone.code] || 'zone-badge-a';

  return (
    <div className="bg-card rounded-xl shadow-card hover:shadow-card-hover transition-all duration-200 border border-border overflow-hidden animate-fade-in">
      {/* Header */}
      <div
