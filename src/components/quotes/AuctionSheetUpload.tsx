...
interface AuctionSheetUploadProps {
  onAnalysisComplete: (analysis: AuctionSheetAnalysis) => void;
  onRemove?: () => void;
  initialAnalysis?: AuctionSheetAnalysis;
}

export function AuctionSheetUpload({ 
  onAnalysisComplete, 
  onRemove,
  initialAnalysis 
}: AuctionSheetUploadProps) {
  const [file, setFile] = useState<File | null>(null);
  const [isAnalyzing, setIsAnalyzing] = useState(false);
  const [analysis, setAnalysis] = useState<AuctionSheetAnalysis | null>(initialAnalysis || null);
