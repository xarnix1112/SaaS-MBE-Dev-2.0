...
`python scripts/check_fillable_fields.py <input.pdf>`, and depending on the result go to either the "Fillable fields" or "Non-fillable fields" and follow those instructions.

# Fillable fields
If the PDF has fillable form fields:
- Run this script from this file's directory: `python scripts/extract_form_field_info.py <input.pdf> <output.json>`. It will create a JSON file with a list of fields in this format:
```
[
  {
...
`python scripts/convert_pdf_to_images.py <output.pdf> <output_directory>`
