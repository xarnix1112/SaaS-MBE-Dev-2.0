...
const quoteStatusConfig: Record<QuoteStatus, { label: string; variant: 'new' | 'pending' | 'verified' | 'info' | 'success' | 'warning' | 'error'; icon: React.ElementType }> = {
  ...
  calculated: { label: 'Calculé', variant: 'info', icon: Package },
  bordereau_linked: { label: 'Bordereau lié', variant: 'info', icon: CheckCircle2 },
  waiting_for_slip: { label: 'En attente bordereau', variant: 'pending', icon: Clock },
